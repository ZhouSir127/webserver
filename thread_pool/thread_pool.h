...
{
public:
    ThreadPool(TimerManager&timerManager,HttpManager&httpManager,const ThreadPoolInfo& threadPoolInfo) 
    :timerManager(timerManager),httpManager(httpManager),threadNumber(threadPoolInfo.threadNumer),maxRequest(threadPoolInfo.maxRequest),stop(false){
